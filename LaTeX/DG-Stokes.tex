...
\begin{align*}
	\ff = \begin{pmatrix}
		\nu 4\pi^3 (4\sin^2(\pi x)-2\cos(2\pi x))\sin(2\pi y)\sin(2\pi z) +\pi\cos(\pi x)\cos(\pi y) \sin(\pi z) \\
		-\nu 2\pi^3 (4\sin^2(\pi y)-2\cos(2\pi y))\sin(2\pi x)\sin(2\pi z) -\pi\sin(\pi x)\sin(\pi y) \sin(\pi z) \\
		-\nu 2\pi^3 (4\sin^2(\pi z)-2\cos(2\pi z))\sin(2\pi x)\sin(2\pi y) +\pi\sin(\pi x)\cos(\pi y)\cos(\pi z)
	\end{pmatrix},
	\quad
	\gbld_\Drm = \zero. 
\end{align*}
